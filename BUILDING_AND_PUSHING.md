...
docker build --pull --rm -t vovimayhem/app-dev:base-ruby dev/base-ruby \
...
docker build --pull --rm -t vovimayhem/app-dev:mri-2.0.0-p645 dev/mri-2.0 \
...
docker build --pull --rm -t vovimayhem/app-dev:mri-2.1.6 dev/mri-2.1 \
...
docker build --pull --rm -t vovimayhem/app-dev:mri-2.2.2 dev/mri-2.2 \
